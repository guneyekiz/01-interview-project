...
public class Driver {
    /*
        Creating the private constructor so this class' ob not reachable from outside
        We cannot do Driver driver = new Driver();ject
        is
         */
    private Driver(){}
    ...
    ensures SINGLE copy of the variables/object
    */
